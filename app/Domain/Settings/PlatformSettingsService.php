    ...
    public function defaults(string $section): array
    {
        return match ($section) {
            ...
            'billing' => [
                ...
                'tax_pin' => 'P051769315N',
                'issuer_phone' => '+254 700 000 000',
                'issuer_email' => 'billing@pradytecai.test',
                'issuer_website' => 'www.pradytecai.com',
                'issuer_address' => 'Nairobi, Kenya',
                ...
                'invoice_footer_notes' => 'Thank you for choosing Prady Technologies.',
                'usage_rate_per_mb' => '0',
                'grace_period_days' => '7',
                'auto_suspend' => true,
                'bank_name' => '',
