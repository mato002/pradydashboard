...
<?php if($href && ! $method): ?>
    <a
        ...
        <?php echo e($attributes->merge($fullNavAttr)->merge($targetAttr)->merge(['class' => $classes, 'role' => 'menuitem'])); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\Desktop\Newfolder\pradydashboard\resources\views/components/ui/row-action.blade.php ENDPATH**/ ?>