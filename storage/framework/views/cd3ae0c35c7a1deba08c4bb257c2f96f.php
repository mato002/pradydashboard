            ...
            <ul class="space-y-2 text-sm">
                <?php $__currentLoopData = $supportSummary['recent_communications']->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <li class="flex flex-wrap justify-between gap-2">
                        <span>
                            <a href="<?php echo e(route('tenants.show', ['tenant' => $comm->tenant, 'tab' => 'communications'])); ?>" class="font-medium text-indigo-600 hover:underline dark:text-indigo-400">
...
<?php /**PATH C:\Users\HP\Desktop\Newfolder\pradydashboard\resources\views/admin/dashboard/partials/support-ops.blade.php ENDPATH**/ ?>