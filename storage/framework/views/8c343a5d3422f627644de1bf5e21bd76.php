...
<div class="space-y-4">
    <div>
        <p class="text-xs font-semibold uppercase tracking-widest text-indigo-600 dark:text-indigo-400"><?php echo e(__('Settings')); ?> · <?php echo e(__('API & Integrations')); ?></p>
        <h2 class="mt-1 text-2xl font-semibold tracking-tight text-slate-900 dark:text-white"><?php echo e(__('Payments Gateway')); ?></h2>
        <p class="mt-1 max-w-3xl text-sm text-slate-500 dark:text-slate-400"><?php echo e(__('Control plane for payments.pradytecai.com — monitor tenants, profiles, PayBill accounts, and gateway health.')); ?></p>
    </div>
...
<?php /**PATH C:\Users\HP\Desktop\Newfolder\pradydashboard\resources\views/settings/integrations/payments-gateway/partials/header.blade.php ENDPATH**/ ?>