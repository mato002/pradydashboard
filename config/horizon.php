    ...
    */
    ...
    'environments' => [
        'production' => [
            ...
            'supervisor-payments' => ['maxProcesses' => 4],
            'supervisor-webhooks' => ['maxProcesses' => 4],
            'supervisor-billing' => ['maxProcesses' => 3],
            'supervisor-telemetry' => ['maxProcesses' => 4],
            'supervisor-emails' => ['maxProcesses' => 6, 'balanceMaxShift' => 1, 'balanceCooldown' => 3],
            'supervisor-pdf' => ['maxProcesses' => 3],
            'supervisor-integrations' => ['maxProcesses' => 3],
        ...
        'local' => [
            ...
            'supervisor-telemetry' => ['maxProcesses' => 1],
