...
<header class="auth-nav-glass-light relative z-50 shrink-0">
    <div class="mx-auto flex h-14 max-w-[1600px] items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        <a href="<?php echo e(route('home')); ?>" class="group flex min-w-0 items-center gap-3 transition-opacity hover:opacity-90">
            <span
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.brand-logo','data' => ['class' => 'h-5 w-5 text-cyan-300']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-5 w-5 text-cyan-300']); ?>
...
<?php endif; ?>
            ...
            <span class="hidden min-w-0 sm:block">
                ...
                <span class="block truncate text-[10px] font-semibold uppercase tracking-[0.22em] text-slate-500 dark:text-slate-400">
                    <?php echo e(__('Operations Cloud')); ?>
        ...
        <div class="flex items-center gap-2">
            <button
                ...
                @click="cycleTheme()"
                :title="theme === 'light' ? '<?php echo e(__('Light mode')); ?>' : theme === 'dark' ? '<?php echo e(__('Dark mode')); ?>' : '<?php echo e(__('System theme')); ?>'"
            >
...
<?php /**PATH C:\Users\HP\Desktop\Newfolder\pradydashboard\resources\views/components/auth/partials/auth-topnav.blade.php ENDPATH**/ ?>