        ...
        <div x-data="pradyShell()" class="relative min-h-full">
            ...
            >
                <div class="flex h-[4.25rem] shrink-0 items-center gap-3 border-b border-sidebar-border px-4">
                    <a href="<?php echo e(route('dashboard')); ?>" data-prady-nav data-turbo-frame="prady-workspace" class="flex min-w-0 items-center gap-3">
                ...
                <header class="sticky top-0 z-20 border-b border-slate-200/80 bg-white/80 shadow-sm backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-950/75">
                    <div class="flex h-[4.25rem] items-center gap-3 px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="hidden min-w-0 flex-1 flex-col md:flex">
                            ...
                            <?php elseif($heading): ?>
                                <h1 id="prady-page-heading" class="truncate text-lg font-semibold tracking-tight text-slate-900 dark:text-white"><?php echo e($heading); ?></h1>
                            <?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('profile.edit'),'dataPradyFullNav' => true,'dataTurboFrame' => '_top']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('profile.edit')),'data-prady-full-nav' => true,'data-turbo-frame' => '_top']); ?><?php echo e(__('Profile')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                        <form method="POST" action="<?php echo e(route('logout')); ?>">
                                            ...
                                            <?php if (isset($component)) { $__componentOriginal68cb1971a2b92c9735f83359058f7108 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal68cb1971a2b92c9735f83359058f7108 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['href' => route('logout'),'dataPradyFullNav' => true,'dataTurboFrame' => '_top','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('logout')),'data-prady-full-nav' => true,'data-turbo-frame' => '_top','onclick' => 'event.preventDefault(); this.closest(\'form\').submit();']); ?>
...
<?php /**PATH C:\xampp\htdocs\prady-dashboard\resources\views/components/prady-shell.blade.php ENDPATH**/ ?>