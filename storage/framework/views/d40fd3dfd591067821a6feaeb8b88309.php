...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="h-full scroll-smooth">
    <head>
        ...
        <title>PradytecAI — <?php echo e(__('Enterprise SaaS & cloud infrastructure for Africa')); ?></title>
    ...
    >
        ...
        <div
            ...
            aria-label="<?php echo e(__('Theme')); ?>"
        >
            <button
                type="button"
        ...
        >
            <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6 lg:px-8">
                <a href="<?php echo e(route('home')); ?>" class="group flex items-center gap-2.5">
                    <span
                ...
                <nav class="hidden items-center gap-1 text-sm font-semibold text-slate-600 md:flex dark:text-slate-300">
                    <a href="#products" class="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-white/5 dark:hover:text-white"><?php echo e(__('Products')); ?></a>
                    <a href="#platform" class="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-white/5 dark:hover:text-white"><?php echo e(__('Platform')); ?></a>
                    <a href="#infrastructure" class="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-white/5 dark:hover:text-white"><?php echo e(__('Infrastructure')); ?></a>
                    <a href="#apis" class="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-white/5 dark:hover:text-white"><?php echo e(__('APIs')); ?></a>
                    <a href="#contact" class="rounded-lg px-3 py-2 transition hover:bg-slate-100 hover:text-slate-900 dark:hover:bg-white/5 dark:hover:text-white"><?php echo e(__('Contact')); ?></a>
                </nav>
                <div class="flex items-center gap-2">
                    ...
                    <?php else: ?>
                        ...
                        <?php endif; ?>
                        <a
                            href="mailto:sales@pradytecai.com?subject=<?php echo e(rawurlencode(__('PradytecAI — demo or architecture discussion'))); ?>"
        ...
        <main>
                ...
                <div class="relative mx-auto grid max-w-7xl gap-12 px-4 py-16 sm:px-6 sm:py-24 lg:grid-cols-2 lg:items-center lg:gap-16 lg:px-8 lg:py-28">
                    <div class="animate-auth-fade-up">
                        <p class="inline-flex items-center gap-2 rounded-full border border-emerald-400/25 bg-emerald-500/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-emerald-200">
                            ...
                            <?php echo e(__('Live operations · Multi-tenant cloud')); ?>

                        </p>
                        <h1 class="mt-6 text-3xl font-bold leading-[1.1] tracking-tight sm:text-4xl lg:text-[2.75rem] xl:text-5xl">
                            <?php echo e(__('Enterprise software infrastructure for modern African businesses')); ?>

                        </h1>
                        <p class="mt-6 max-w-xl text-base leading-relaxed text-slate-300 sm:text-lg">
                            <?php echo e(__('PradytecAI designs, hosts, and operates cloud-native business systems—CRM, microfinance, property, ISP, and automation—so your teams run on infrastructure-grade platforms, not one-off websites.')); ?>

                        </p>
                        <div class="mt-10 flex flex-wrap items-center gap-3">
                            <a
                                href="mailto:sales@pradytecai.com?subject=<?php echo e(rawurlencode(__('Request a technical demo'))); ?>"
                        ...
                        <dl class="mt-12 grid grid-cols-2 gap-4 border-t border-white/10 pt-10 sm:grid-cols-3">
                            <div>
                                <dt class="text-[11px] font-semibold uppercase tracking-wider text-slate-500"><?php echo e(__('Stack')); ?></dt>
                                <dd class="mt-1 text-sm font-semibold text-white"><?php echo e(__('API-first · Multi-tenant')); ?></dd>
                            </div>
                            <div>
                                <dt class="text-[11px] font-semibold uppercase tracking-wider text-slate-500"><?php echo e(__('Posture')); ?></dt>
                                <dd class="mt-1 text-sm font-semibold text-white"><?php echo e(__('Monitored · Backed up · Audited')); ?></dd>
                            </div>
                            <div class="col-span-2 sm:col-span-1">
                                <dt class="text-[11px] font-semibold uppercase tracking-wider text-slate-500"><?php echo e(__('Delivery')); ?></dt>
                                <dd class="mt-1 text-sm font-semibold text-white"><?php echo e(__('African realities · Global reliability')); ?></dd>
                            </div>
                        </dl>
                    </div>
                    ...
                    <div class="relative mx-auto w-full max-w-lg lg:mx-0 lg:max-w-none animate-auth-fade-up-delay">
                        ...
                        >
                            <div class="flex items-center justify-between border-b border-white/5 px-4 py-3">
                                ...
                                <span class="rounded-full bg-emerald-500/15 px-2 py-0.5 text-[10px] font-semibold text-emerald-300 ring-1 ring-emerald-400/30">
                                    <?php echo e(__('All regions healthy')); ?>

                                </span>
                            </div>
                            <div class="flex min-h-[320px]">
                                <div class="hidden w-14 shrink-0 border-r border-white/5 bg-slate-900/50 py-3 sm:block">
                                    <?php $__currentLoopData = ['T', 'S', 'B', 'M', 'A']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="mx-auto mb-2 h-8 w-8 rounded-lg bg-white/5 text-center text-[10px] font-bold leading-8 text-slate-500"><?php echo e($g); ?></div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                                <div class="flex-1 p-4 sm:p-5">
                                    <div class="flex flex-wrap items-end justify-between gap-3">
                                        <div>
                                            <p class="text-[11px] font-semibold uppercase tracking-wider text-slate-500"><?php echo e(__('Throughput (24h)')); ?></p>
                                        ...
                                        <div class="rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-right">
                                            <p class="text-[10px] font-medium uppercase text-slate-500"><?php echo e(__('API p99')); ?></p>
                                            <p class="font-mono text-sm font-semibold text-cyan-300">142ms</p>
                                        </div>
                                    </div>
                                    <div class="mt-5 flex h-24 items-end gap-1" aria-hidden="true">
                                        <?php $__currentLoopData = [32, 48, 40, 64, 52, 72, 58, 80, 68, 88, 76, 92]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div
                                    ...
                                    <div class="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3">
                                        <div class="rounded-xl border border-white/10 bg-white/[0.04] p-3 ring-1 ring-white/5">
                                            <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500"><?php echo e(__('Tenants')); ?></p>
                                        ...
                                        <div class="rounded-xl border border-white/10 bg-white/[0.04] p-3 ring-1 ring-white/5">
                                            <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500"><?php echo e(__('Deployments')); ?></p>
                                        ...
                                        <div class="col-span-2 rounded-xl border border-white/10 bg-white/[0.04] p-3 ring-1 ring-emerald-500/20 sm:col-span-1">
                                            <p class="text-[10px] font-medium uppercase tracking-wide text-slate-500"><?php echo e(__('Uptime (rolling)')); ?></p>
                        ...
                        >
                            <p class="text-[10px] font-medium uppercase text-slate-500"><?php echo e(__('Messages / day')); ?></p>
                        ...
                        >
                            <p class="text-[10px] font-medium uppercase text-cyan-200/80"><?php echo e(__('Edge nodes')); ?></p>
            ...
            <section id="platform" class="border-b border-slate-200/80 bg-white py-16 dark:border-white/[0.06] dark:bg-[#0a0f1a]">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="mx-auto max-w-3xl text-center">
                        <h2 class="text-xs font-bold uppercase tracking-[0.28em] text-indigo-600 dark:text-indigo-400"><?php echo e(__('Operational proof')); ?></h2>
                        <p class="mt-4 text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
                            <?php echo e(__('Systems that stay up when your business is on the line')); ?>

                        </p>
                        <p class="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                            <?php echo e(__('Representative platform telemetry from production-style workloads. Your numbers depend on deployment scope—we engineer for the same discipline.')); ?>
                    ...
                    >
                        ...
                        <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            >
                                <p class="text-[10px] font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400"><?php echo e($m['label']); ?></p>
                                <?php if(($m['fmt'] ?? '') === 'compact'): ?>
                                    <p
                                        class="mt-2 font-mono text-xl font-bold tabular-nums text-slate-900 dark:text-white"
                                        x-data="countUp(<?php echo e($m['end']); ?>)"
                                ...
                                <?php else: ?>
                                    <p
                                        class="mt-2 font-mono text-xl font-bold tabular-nums text-slate-900 dark:text-white"
                                        x-data="countUp(<?php echo e($m['end']); ?>)"
                                        x-text="display.toLocaleString() + '<?php echo e($m['suffix']); ?>'"
                                    >
                                        0
                                    </p>
                                <?php endif; ?>
            ...
            <section id="products" class="scroll-mt-24 border-b border-slate-200/80 bg-slate-50 py-20 dark:border-white/[0.06] dark:bg-[#030712]">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                        <div class="max-w-2xl">
                            <h2 class="text-xs font-bold uppercase tracking-[0.28em] text-indigo-600 dark:text-indigo-400"><?php echo e(__('Product ecosystem')); ?></h2>
                            <p class="mt-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white">
                                <?php echo e(__('Vertical SaaS you operate—not spreadsheets you babysit')); ?>

                            </p>
                            <p class="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                                <?php echo e(__('Each line of business gets a dedicated surface: messaging CRM, regulated lending, property operations, ISP networks, and shared enterprise APIs—unified by tenancy, security, and observability.')); ?>
                        ...
                        >
                            <?php echo e(__('Talk to solutions engineering')); ?>
                        ...
                        <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            >
                                <div class="flex items-start justify-between gap-3">
                                    <h3 class="text-lg font-bold text-slate-900 dark:text-white"><?php echo e($p['name']); ?></h3>
                                    <span
                                ...
                                <p class="mt-3 flex-1 text-sm leading-relaxed text-slate-600 dark:text-slate-400"><?php echo e($p['desc']); ?></p>
                                <ul class="mt-4 space-y-2 border-t border-slate-100 pt-4 text-sm text-slate-700 dark:border-white/[0.06] dark:text-slate-300">
                                    <?php $__currentLoopData = $p['bullets']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $b): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="flex gap-2">
                                ...
                                <div class="mt-5 flex items-center justify-between gap-3 border-t border-slate-100 pt-4 dark:border-white/[0.06]">
                                    <div class="flex h-10 flex-1 items-end gap-0.5 opacity-80" aria-hidden="true">
                                        <?php $__currentLoopData = [40, 55, 48, 70, 52, 68]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex-1 rounded-sm bg-gradient-to-t from-indigo-500/30 to-violet-400/50" style="height: <?php echo e($h); ?>%"></div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                    <a
                                        href="<?php echo e($p['href']); ?>"
                                        <?php if(! empty($p['external'])): ?> target="_blank" rel="noopener noreferrer" <?php endif; ?>
            ...
            >
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="max-w-3xl">
                        <h2 class="text-xs font-bold uppercase tracking-[0.28em] text-cyan-300/90"><?php echo e(__('Infrastructure & reliability')); ?></h2>
                        <p class="mt-4 text-3xl font-bold tracking-tight">
                            <?php echo e(__('We do not “host a website.” We run production systems.')); ?>

                        </p>
                        <p class="mt-4 text-sm leading-relaxed text-slate-400">
                            <?php echo e(__('Cloud-native patterns, disciplined DevOps, and security defaults you would expect from a serious SaaS operator—applied to African connectivity, compliance, and uptime realities.')); ?>
                    ...
                    <div class="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <?php $__currentLoopData = [
                            ...
                            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cell): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div
                            ...
                            >
                                <h3 class="text-sm font-bold text-white"><?php echo e($cell['t']); ?></h3>
                                <p class="mt-2 text-sm leading-relaxed text-slate-400"><?php echo e($cell['d']); ?></p>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
            ...
            <section class="border-b border-slate-200/80 bg-white py-20 dark:border-white/[0.06] dark:bg-[#0a0f1a]">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="mx-auto max-w-3xl text-center">
                        <h2 class="text-xs font-bold uppercase tracking-[0.28em] text-indigo-600 dark:text-indigo-400"><?php echo e(__('Control plane')); ?></h2>
                        <p class="mt-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white">
                            <?php echo e(__('One serious console for operators and executives')); ?>
                    ...
                    <div class="relative mt-16">
                        ...
                        <div class="relative mx-auto max-w-5xl">
                            ...
                            >
                                <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500"><?php echo e(__('Tenants')); ?></p>
                                <p class="mt-1 text-sm font-semibold text-slate-900 dark:text-white"><?php echo e(__('Provisioning queue')); ?></p>
                            ...
                            >
                                <div class="flex items-center gap-2 border-b border-slate-200/80 bg-white px-4 py-3 dark:border-white/10 dark:bg-slate-900">
                                    <span class="text-xs font-semibold text-slate-500"><?php echo e(__('Live')); ?></span>
                                    <span class="rounded-full bg-emerald-500/15 px-2 py-0.5 text-[10px] font-bold text-emerald-700 dark:text-emerald-300"><?php echo e(__('Billing sync OK')); ?></span>
                                </div>
                                <div class="grid gap-0 lg:grid-cols-[1fr_280px]">
                                    <div class="border-b border-slate-200/80 p-6 dark:border-white/10 lg:border-b-0 lg:border-r">
                                        <div class="grid gap-4 sm:grid-cols-3">
                                            <?php $__currentLoopData = [
                                                ...
                                                <div class="rounded-xl border border-slate-200/80 bg-white p-4 dark:border-white/10 dark:bg-slate-900/80">
                                                    <p class="text-[10px] font-bold uppercase tracking-wide text-slate-500"><?php echo e($kpi[0]); ?></p>
                                                    <p class="mt-2 font-mono text-lg font-bold text-slate-900 dark:text-white"><?php echo e($kpi[1]); ?></p>
                                                    <p class="mt-1 text-[11px] font-medium text-emerald-600 dark:text-emerald-400"><?php echo e($kpi[2]); ?></p>
                                                </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                        <div class="mt-6 h-36 rounded-xl border border-slate-200/80 bg-gradient-to-b from-white to-slate-50 p-4 dark:border-white/10 dark:from-slate-900 dark:to-slate-950">
                                            <p class="text-[10px] font-bold uppercase text-slate-500"><?php echo e(__('Server CPU (avg)')); ?></p>
                                            <div class="mt-4 flex h-20 items-end gap-1">
                                                <?php $__currentLoopData = [35, 42, 38, 55, 48, 62, 58, 52, 48, 44, 50, 46]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $h): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="flex-1 rounded-t bg-indigo-500/70 dark:bg-indigo-400/60" style="height: <?php echo e($h); ?>%"></div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="space-y-4 bg-white p-6 dark:bg-slate-900/50">
                                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500"><?php echo e(__('Activity')); ?></p>
                                        <?php $__currentLoopData = [
                                            ...
                                            <div class="flex items-center justify-between gap-2 rounded-lg border border-slate-100 bg-slate-50/80 px-3 py-2 text-xs dark:border-white/5 dark:bg-slate-950/60">
                                                <span class="font-medium text-slate-800 dark:text-slate-200"><?php echo e($row[0]); ?></span>
                                                <span class="font-mono text-[10px] text-slate-500"><?php echo e($row[1]); ?></span>
                                                <span class="text-slate-400"><?php echo e($row[2]); ?></span>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                                </div>
                            ...
                            <p class="mt-6 text-center text-xs text-slate-500 dark:text-slate-500">
                                <?php echo e(__('Illustrative UI composition. Your branding, data regions, and modules ship to match contract.')); ?>
            ...
            <section class="border-b border-slate-200/80 bg-slate-50 py-20 dark:border-white/[0.06] dark:bg-[#030712]">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
                        <div>
                            <h2 class="text-xs font-bold uppercase tracking-[0.28em] text-indigo-600 dark:text-indigo-400"><?php echo e(__('Why PradytecAI')); ?></h2>
                            <p class="mt-4 text-3xl font-bold tracking-tight text-slate-900 dark:text-white">
                                <?php echo e(__('Built for African operations. Engineered like global SaaS.')); ?>

                            </p>
                            <p class="mt-4 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                                <?php echo e(__('We combine product discipline with infrastructure seriousness: the same rigor you would demand from a cloud vendor, applied to CRM, finance, property, and network workloads that power real economies.')); ?>
                        ...
                        <ul class="space-y-4">
                            <?php $__currentLoopData = [
                                ...
                                <li class="flex gap-4 rounded-2xl border border-slate-200/90 bg-white p-4 dark:border-white/[0.06] dark:bg-[#0c1222]">
                                    ...
                                    <span class="text-sm font-medium leading-relaxed text-slate-800 dark:text-slate-200"><?php echo e($why); ?></span>
                                </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </ul>
                    </div>
            ...
            <section id="apis" class="scroll-mt-24 border-b border-white/5 bg-[#070b14] py-20 text-slate-100">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="grid gap-12 lg:grid-cols-2 lg:items-start">
                        <div>
                            <h2 class="text-xs font-bold uppercase tracking-[0.28em] text-cyan-300/90"><?php echo e(__('APIs & automation')); ?></h2>
                            <p class="mt-4 text-3xl font-bold tracking-tight text-white">
                                <?php echo e(__('Your systems should orchestrate—not manually chase each other')); ?>

                            </p>
                            <p class="mt-4 text-sm leading-relaxed text-slate-400">
                                <?php echo e(__('Webhooks, signed callbacks, idempotent endpoints, and event contracts designed for finance-grade retries. Automation flows connect CRM, MFI cores, property ledgers, and ISP OSS without brittle screen-scraping.')); ?>

                            </p>
                            <ul class="mt-8 space-y-3 text-sm text-slate-300">
                                <li class="flex gap-2">
                                    <span class="text-cyan-400">▹</span>
                                    <?php echo e(__('Versioned REST + webhook signatures (HMAC) for partner trust')); ?>

                                </li>
                                <li class="flex gap-2">
                                    <span class="text-cyan-400">▹</span>
                                    <?php echo e(__('Per-tenant API keys, quotas, and abuse-aware rate limits')); ?>

                                </li>
                                <li class="flex gap-2">
                                    <span class="text-cyan-400">▹</span>
                                    <?php echo e(__('Playbooks for ERP, banking, M-Pesa-style rails, and internal data lakes')); ?>
  ...
  "data": {
    ...
    "segments": ["collections", "d30"]
            ...
            <section class="border-b border-slate-200/80 bg-white py-20 dark:border-white/[0.06] dark:bg-[#0a0f1a]">
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <h2 class="text-center text-xs font-bold uppercase tracking-[0.28em] text-indigo-600 dark:text-indigo-400"><?php echo e(__('Operator voices')); ?></h2>
                    <p class="mx-auto mt-4 max-w-2xl text-center text-2xl font-bold tracking-tight text-slate-900 dark:text-white">
                        <?php echo e(__('Reliability and clarity where we could not afford surprises')); ?>
                    ...
                    <div class="mt-14 grid gap-6 md:grid-cols-3">
                        <?php $__currentLoopData = [
                            ...
                            >
                                <p class="flex-1 text-sm leading-relaxed text-slate-700 dark:text-slate-300">“<?php echo e($t['q']); ?>”</p>
                                <footer class="mt-6 border-t border-slate-200/80 pt-4 text-xs dark:border-white/[0.06]">
                                    <p class="font-bold text-slate-900 dark:text-white"><?php echo e($t['r']); ?></p>
                                    <p class="mt-1 text-slate-500"><?php echo e($t['c']); ?></p>
                                </footer>
                            </blockquote>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <p class="mx-auto mt-10 max-w-2xl text-center text-[11px] leading-relaxed text-slate-500">
                        <?php echo e(__('Quotes reflect composite operator feedback from engagements; names withheld for confidentiality. We will introduce referenceable customers where contracts allow.')); ?>
            ...
            <section id="contact" class="scroll-mt-24 bg-gradient-to-br from-indigo-950 via-slate-900 to-[#020617] py-24 text-white">
                <div class="mx-auto max-w-4xl px-4 text-center sm:px-6">
                    <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">
                        <?php echo e(__('Build your business on reliable SaaS infrastructure')); ?>

                    </h2>
                    <p class="mx-auto mt-5 max-w-2xl text-sm leading-relaxed text-slate-300">
                        <?php echo e(__('Bring your technical lead—we will walk architecture, security, SLAs, and rollout. No generic slide decks; concrete control-plane design.')); ?>

                    </p>
                    <div class="mt-10 flex flex-wrap items-center justify-center gap-3">
                        <a
                            href="mailto:sales@pradytecai.com?subject=<?php echo e(rawurlencode(__('Schedule a demo — PradytecAI'))); ?>"
                        ...
                        >
                            <?php echo e(__('Schedule demo')); ?>

                        </a>
                        <a
                            href="mailto:sales@pradytecai.com?subject=<?php echo e(rawurlencode(__('Talk to PradytecAI solutions team'))); ?>"
                        ...
                        >
                            <?php echo e(__('Talk to our team')); ?>
        ...
        <footer class="border-t border-slate-200/80 bg-slate-50 dark:border-white/[0.06] dark:bg-[#030712]">
            <div class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
                <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-6">
                    <div class="lg:col-span-2">
                        ...
                        <p class="mt-4 max-w-sm text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                            <?php echo e(__('African enterprise SaaS and cloud infrastructure—CRM, MFI, property, ISP, APIs, and the control plane that runs them.')); ?>

                        </p>
                    </div>
                    <div>
                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500"><?php echo e(__('Products')); ?></p>
                        <ul class="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                            ...
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#contact"><?php echo e(__('Prady MFI')); ?></a></li>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#contact"><?php echo e(__('Property OS')); ?></a></li>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#contact"><?php echo e(__('ISP Control')); ?></a></li>
                        </ul>
                    </div>
                    <div>
                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500"><?php echo e(__('Infrastructure')); ?></p>
                        <ul class="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#infrastructure"><?php echo e(__('Cloud & HA')); ?></a></li>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#infrastructure"><?php echo e(__('Monitoring')); ?></a></li>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#infrastructure"><?php echo e(__('Backups & DR')); ?></a></li>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#infrastructure"><?php echo e(__('Security')); ?></a></li>
                        </ul>
                    </div>
                    <div>
                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500"><?php echo e(__('APIs')); ?></p>
                        <ul class="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#apis"><?php echo e(__('Webhooks')); ?></a></li>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#apis"><?php echo e(__('Integration guides')); ?></a></li>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="#apis"><?php echo e(__('Tenant keys')); ?></a></li>
                        </ul>
                    </div>
                    <div>
                        <p class="text-xs font-bold uppercase tracking-wider text-slate-500"><?php echo e(__('Company')); ?></p>
                        <ul class="mt-4 space-y-2 text-sm text-slate-700 dark:text-slate-300">
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?></a></li>
                            <?php if(auth()->guard()->check()): ?>
                                <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Console')); ?></a></li>
                            <?php else: ?>
                                <?php if(Route::has('login')): ?>
                                    <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="<?php echo e(route('login')); ?>"><?php echo e(__('Sign in')); ?></a></li>
                                <?php endif; ?>
                            <?php endif; ?>
                            <li><a class="hover:text-indigo-600 dark:hover:text-indigo-400" href="mailto:sales@pradytecai.com"><?php echo e(__('Contact')); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div
                ...
                >
                    <p>© <?php echo e(now()->year); ?> PradytecAI · <?php echo e(__('All rights reserved.')); ?></p>
                    <p class="tabular-nums"><?php echo e(__('Version')); ?> <?php echo e(config('app.version', '1.0.0')); ?></p>
                </div>
            </div>
        </footer>
    </body>
</html>
<?php /**PATH C:\Users\HP\Desktop\Newfolder\pradydashboard\resources\views/landing.blade.php ENDPATH**/ ?>